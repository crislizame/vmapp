...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Ingreso - Naturlifeec</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Naturlife</span>
								
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Naturlife</h4>
							</div>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" id="name" class="form-control" placeholder="Nombre de Usuario" />
													...
													<div class="clearfix">
														<label class="inline">
															<input type="checkbox" id="sessionn" class="ace" />
