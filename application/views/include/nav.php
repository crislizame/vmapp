<div class="navbar-header pull-left">
					<a href="index.html" class="navbar-brand">
						<small>
							...
							Sistema <i class="fa fa-leaf"></i>Naturlife
						</small>
					</a>
				</div>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="<?= base_url() ?>index.php/home/salir">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
                ...
                <li class="">
						<a href="<?= base_url() ?>index.php/sistema" class="">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								...
								<ul class="submenu">
									<li class="">
										<a href="<?= base_url(); ?>index.php/sistema/panel/cliente/nuevo">
									...
									<li class="">
										<a href="<?= base_url(); ?>index.php/sistema/panel/cliente/actualizar">
